...
import { Volunteering } from "@/features/portfolio/components/volunteering"
    ...
    <>
      ...
      <div className="[--separator-height:--spacing(8)] **:data-[slot=panel]:scroll-mt-[calc(var(--header-height)+var(--separator-height))]">
        <div className="mx-auto md:max-w-3xl">
          ...
          <div className="flex flex-col items-center justify-center py-6 text-center text-xs text-muted-foreground border-x border-line bg-background">
            <p>Original design by Chanh Dai</p>
            <p>
              Credits to{" "}
              <a
                href="https://github.com/ncdai/chanhdai.com?utm_source=chanhdai.com"
                target="_blank"
                rel="noopener"
